...
public enum AuthErrorCode {
    ...
    ADMIN_LOGIN_DISABLED(HttpStatus.BAD_REQUEST, "AUTH_ADMIN_LOGIN_DISABLED", "관리자 로그인이 현재 비활성화되어 있습니다."),
    ...
    DEVICE_ALREADY_LINKED_TO_ANOTHER_ACCOUNT(HttpStatus.CONFLICT, "AUTH_DEVICE_ALREADY_LINKED_TO_ANOTHER_ACCOUNT", "이 디바이스는 이미 다른 소셜 계정에 연결되어 있습니다."),
