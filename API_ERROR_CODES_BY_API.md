...
- `409 CONFLICT`: `AUTH_EMAIL_ALREADY_REGISTERED`, `AUTH_DEVICE_ALREADY_LINKED_TO_ANOTHER_ACCOUNT`
...
- `429 TOO_MANY_REQUESTS`: `NICKNAME_CHANGE_TOO_EARLY`
...
- `POST /social/login`
  ...
  - `AUTH_DEVICE_ALREADY_LINKED_TO_ANOTHER_ACCOUNT`
  - `USER_DELETED`
  - `USER_SUSPENDED`
  - `USER_RESTRICTED`
- `POST /email/login`
...
- `PATCH /api/v1/users/me/nickname` 는 14일 이내 재변경 시 `NICKNAME_CHANGE_TOO_EARLY` 가능
